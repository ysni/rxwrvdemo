...
QList<WeatherData *> MyJsonParse::getWeatherList() const
{
    ...
    if (m_success){
        ...
        for (auto it : array){
            ...
            if (weather.left(1) == "晴")
                imagestr = "fine";
            else if (weather.left(2) == "多云")
                imagestr = "cloudy";
            else if (weather.left(1) == "阴")
                imagestr = "sky";
            ...
            weatherData->setDayPicture("qrc:/images/" + imagestr + "_sun.png");
            weatherData->setNightPicture("qrc:/images/" + imagestr + "_moon.png");
